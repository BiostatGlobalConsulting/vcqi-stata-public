*! loneway_plus version 1.0 Biostat Global Consulting 2020-05-26
*! version 3.2.1  24feb2016
*
* This so-called _plus version, outputs the ms_w and ms_b also.  
* Otherwise it is unchanged from Stata's v3.2.1.
*
program define loneway_plus, rclass byable(recall) sort
	version 6.0, missing
	...
	/* Additional output for _plus version */
	return scalar ms_b = `SSA'/`DFA'
	return scalar ms_w = `SSW'/`DFW'
