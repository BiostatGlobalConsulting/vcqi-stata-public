*! SIA_COVG_01_06PO version 1.07 - Biostat Global Consulting - 2021-02-14
*******************************************************************************
* Change log
* 				Updated
*				version
		...
		if "$VCQI_MAKE_OP_PLOTS" == "1" {
			...
			* Now make the plots themselves - one for each stratum
			...
			forvalues i = 1/`opp_nstrata' {
				...
				local filestub SIA_COVG_01_${ANALYSIS_COUNTER}_opplot_siadose_`opp_stratum_id_`i''_`opp_stratum_name_`i''
