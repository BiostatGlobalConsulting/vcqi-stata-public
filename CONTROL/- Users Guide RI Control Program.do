...
vcqi_global SHIFTTO_1       penta1 penta2 penta3 // List of doses where evidence will be shifted *to*
vcqi_global SHIFTFROM_1     penta4 penta5	       // List of doses where evidence will be shifted *from*

vcqi_global SHIFTTO_2       polio1 polio2 polio3 // List of doses where evidence will be shifted *to*
vcqi_global SHIFTFROM_2     polio4 polio5	       // List of doses where evidence will be shifted *from*
...
vcqi_global RI_QUAL_04_TO_TITLE       `=upper("$RI_QUAL_04_DOSE_NAME")' Received Before Age 6 Months
vcqi_global RI_QUAL_04_TO_SUBTITLE
vcqi_global RI_QUAL_04_TO_FOOTNOTE_1  Note: This measure is an unweighted summary of a proportion from the survey sample.
vcqi_global SORT_PLOT_LOW_TO_HIGH 1 // 1 means show strata w/ low outcomes at bottom and high at top
                                    // 0 is the opposite
...
* This indicator makes plots (1) if any MOV and (2) if corrected. These are sorted in opposite directions, so global SORT_PLOT_LOW_TO_HIGH is set inside RI_QUAL_09_06PO.ado rather than here by the user.
...
*                                       and RI_VCTC_01
* 2021-02-14	1.06	Dale Rhoda		Tidy up and document in the updated
