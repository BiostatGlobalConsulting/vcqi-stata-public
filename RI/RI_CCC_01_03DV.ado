*! RI_CCC_01_03DV version 1.01 - Biostat Global Consulting - 2020-04-28
*******************************************************************************
* Change log
* 				Updated
*				version
...
program define RI_CCC_01_03DV
	version 14.1
	
	local oldvcp $VCP
	global VCP RI_CCC_01_03DV
		...
		* Calculate x-max...
		foreach cr in card register {
			...
			* Now update xmax_card & xmax_register based on the data...
			...
			gen xmax_`cr' = $RI_CCC_01_XMAX_INTERVAL * ceil(xmax_temp2_`cr'/$RI_CCC_01_XMAX_INTERVAL) // round up to the nearest xmax_interval (default is 50)
		...
		save "${VCQI_OUTPUT_FOLDER}/RI_CCC_01_${ANALYSIS_COUNTER}", replace
	}
