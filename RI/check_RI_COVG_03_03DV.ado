...
program define check_RI_COVG_03_03DV
	...
	capture confirm file "${VCQI_OUTPUT_FOLDER}/RI_COVG_03_${ANALYSIS_COUNTER}.dta"
	if _rc != 0 {
		...
		if _rc == 0 {
			...
			local exitflag 1 
			di as error  				  "The file ${VCQI_OUTPUT_FOLDER}/RI_COVG_03_${ANALYSIS_COUNTER}.dta does not exist. Run RI_COVG_03_03DV"
			vcqi_log_comment $VCP 1 Error "The file ${VCQI_OUTPUT_FOLDER}/RI_COVG_03_${ANALYSIS_COUNTER}.dta does not exist. Run RI_COVG_03_03DV"
		}
	}
