*! RI_QUAL_09 version 1.02 - Biostat Global Consulting - 2017-08-26
*******************************************************************************
* Change log
* 				Updated
*				version
...
program define RI_QUAL_09
	version 14.1
	
	local oldvcp $VCP
	global VCP RI_QUAL_09
	...
	if "$VCQI_NO_DOBS" == "1" {
		...
		if "$VCQI_PREPROCESS_DATA" 		== "1" RI_QUAL_09_01PP
