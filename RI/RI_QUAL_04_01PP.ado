*! RI_QUAL_04_01PP version 1.04 - Biostat Global Consulting - 2017-08-26
*******************************************************************************
* Change log
* 				Updated
*				version
...
* 2017-02-01	1.03	Dale Rhoda		Cleaned up dlist
* 2017-08-26	1.04	Mary Prier		Added version 14.1 line
*******************************************************************************

program define RI_QUAL_04_01PP
	version 14.1
	
	local oldvcp $VCP
	global VCP RI_QUAL_04_01PP
	...
	quietly {
		...
		save "${VCQI_OUTPUT_FOLDER}/RI_QUAL_04_${ANALYSIS_COUNTER}", replace

		vcqi_global RI_QUAL_04_TEMP_DATASETS $RI_QUAL_04_TEMP_DATASETS RI_QUAL_04_${ANALYSIS_COUNTER}
	}
