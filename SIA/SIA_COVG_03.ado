...
program define SIA_COVG_03
	...
	if "$VCQI_GENERATE_DATABASES" 	== "1" noi di as text _col(3) "Generating output database for age:"
	if "$VCQI_GENERATE_DATABASES" 	== "1" SIA_COVG_03_04GO
	if "$EXPORT_TO_EXCEL" 			== "1" noi di as text _col(3) "Exporting to Excel for age:"
